...
the imageparse program was inspired by [Sudoku_ai](https://github.com/Joy2469/Sudoku_AI.git), however it does a bit more than I need it to and I am actively simplifying the program.
